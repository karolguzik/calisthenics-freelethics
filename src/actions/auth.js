...
import { clearProgressStore } from './progress';
import { clearStatisticsStore } from './statistics';
...
export const logout = () => dispatch => {
  ...
  dispatch(clearTrainingsStore());
  dispatch(clearProgressStore());
  dispatch(clearStatisticsStore());
}
